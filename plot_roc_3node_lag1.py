...
# ── 1. 데이터 로드 ──────────────────────────────────────────────
lambdas       = np.load("results/3node_lag1_lambdas.npy")
binary_scores = np.load("results/3node_lag1_lambda_sweep_binary_scores.npy")
...
fig.suptitle("Neural-GC Baseline — 3-node, lag=1\nROC Curve (λ sweep)", fontsize=13)
...
plt.tight_layout()
out_path = "results/roc_3node_lag1.png"
